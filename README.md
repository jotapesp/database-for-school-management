...
(PT-BR)
* Use o comando `git clone https://github.com/jotapesp/database-for-school-management.git` em um terminal/linha de comando para clonar os arquivos desse repositório e execute os scripts MySQL abaixo.
